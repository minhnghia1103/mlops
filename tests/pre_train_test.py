...
def test_image_size(data_preparation):
    ...
    assert transformed_image.shape[1:] == config.INPUT_SIZE, "Ảnh sau khi resize không đạt kích thước 224x224."
...
def test_image_mode(data_preparation):
    ...
    image = Image.open(r"C:\Users\Nam Dao\Desktop\AI_SOICT_HUST\4_MLOPs\mlops\predata.png")  # Đường dẫn tới ảnh cần kiểm tra
